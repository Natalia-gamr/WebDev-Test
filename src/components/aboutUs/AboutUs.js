...
const AboutUs = () => {
    return (
        <div className="max-w-[1024px] my-[37px] mx-auto flex">
            <div className="max-w-[542px]">
                <h2 className="font-bold text-3xl uppercase border-b-[3px] max-w-[80px] border-lime ">О нас</h2>
            ...
            <div className="relative w-full h-full">
                <img className="absolute right-20 top-20 -z-10 h-[517px] max-w-[791px]" src={mans} alt="" />
            </div>
        </div>
    )
}
